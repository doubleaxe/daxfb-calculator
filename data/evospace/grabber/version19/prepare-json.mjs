...
export class ItemsList {
    ...
    async parseJsonFileAsync(jsonPath) {
        ...
        for(const object of jsonFile.Objects) {
            ...
            if(!processing)
                continue;
            const destObject = processing.destObject(object, this.#objects);
    ...
    static #processing = {
        StaticItem: {
            destObject: (item, objects) => {
                ...
                item.Class = 'SolidStaticItem';
                return objects.solidStaticItem;
            },
        ...
        BaseRecipeDictionary: {
            destObject: (item, objects) => objects.baseRecipeDictionary,
